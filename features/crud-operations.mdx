...
// TypeScript-style interface example in JS (for clarity)
const user = await db.createDocument('users', {
  name: 'Jane Smith',
...
console.log(user.data.name); // Type-safe structure assumed
```
</Tab>
...
<Tab title="HTTP">
```bash
curl -X POST https://api.cocobase.cc/collections/users/documents \
...
<Tab title="HTTP">
```bash
curl -X POST https://api.cocobase.cc/collections/users/batch/documents \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
  -d '{
    "documents": [
...
<Tab title="HTTP">
```bash
curl https://api.cocobase.cc/collections/users/documents/user-123 \
  -H "X-API-Key: your-api-key"
```
</Tab>
</Tabs>
...
<Tab title="HTTP">
```bash
curl https://api.cocobase.cc/collections/users/documents \
  -H "X-API-Key: your-api-key"
```
</Tab>
</Tabs>
...
```bash
# Get active users
curl "https://api.cocobase.cc/collections/users/documents?active=true" \
  -H "X-API-Key: your-api-key"

# Get users older than 25
curl "https://api.cocobase.cc/collections/users/documents?age_gte=25" \
  -H "X-API-Key: your-api-key"

# Multiple filters (AND logic)
curl "https://api.cocobase.cc/collections/users/documents?active=true&age_gte=25&age_lte=40" \
  -H "X-API-Key: your-api-key"
```
</Tab>
</Tabs>
...
<Tab title="HTTP">
```bash
curl -X PATCH https://api.cocobase.cc/collections/users/documents/user-123 \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
  -d '{
    "age": 31,
...
<Tab title="HTTP">
```bash
curl -X POST https://api.cocobase.cc/collections/users/batch/documents/update \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
  -d '{
    "updates": {
...
<Tab title="HTTP">
```bash
curl -X DELETE https://api.cocobase.cc/collections/users/documents/user-123 \
  -H "X-API-Key: your-api-key"
```
</Tab>
</Tabs>
...
<Tab title="HTTP">
```bash
curl -X POST https://api.cocobase.cc/collections/users/batch/documents/delete \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
  -d '{
...
# Query non-deleted items
curl "https://api.cocobase.cc/collections/users/documents?deleted=false" \
  -H "X-API-Key: your-api-key"
```
</Tab>
</Tabs>
