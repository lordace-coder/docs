...
<Tab title="HTTP">
```bash
curl "https://api.cocobase.buzz/collections/posts/documents?%5Bor%5Dauthor_id=user-123&%5Bor%5Dfollowers_array_contains=user-123&status=published&orderBy=created_at&order=desc&limit=20&offset=0" \
  -H "X-API-Key: your-api-key"
```
</Tab>
</Tabs>
